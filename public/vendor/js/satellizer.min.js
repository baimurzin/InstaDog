            ...
            if (token) {
                if (token.split(".").length === 3) {
                    try {
                        ...
                        if (exp) {
                            return Math.round((new Date).getTime() / 1e3) >= exp ? false : true
                        }
                    } catch (e) {
                        return true
                    }
